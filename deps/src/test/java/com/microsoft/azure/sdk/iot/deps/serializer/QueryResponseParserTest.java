...
public class QueryResponseParserTest
{
    ...
    public void constructorSucceeds() throws IllegalArgumentException
    {
        ...
        //assert
        Helpers.assertListEquals(buildListFromJsonArray(VALID_JSON_ARRAY_1), testParser.getJsonItems());
    }
    ...
    public void getJsonItemsGets() throws IllegalArgumentException
    {
        ...
        //act/assert
        Helpers.assertListEquals(buildListFromJsonArray(VALID_TWIN_JSON_ARRAY_2), testParser.getJsonItems());
    }
    ...
    public void getJsonItemsGets2() throws IllegalArgumentException
    {
        ...
        //act/assert
        Helpers.assertListEquals(buildListFromJsonArray(VALID_JSON_ARRAY_2), testParser.getJsonItems());
    }
